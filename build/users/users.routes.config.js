...
var UsersRoutes = /** @class */ (function (_super) {
    ...
    function UsersRoutes(app, usersService) {
    ...
    UsersRoutes.prototype.configureRoutes = function () {
        ...
        this.app
            ...
            var _a, username, password, result, e_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        _a = req.body, username = _a.username, password = _a.password;
                        return [4 /*yield*/, this.usersService.authenticateUser(username, password)];
                    case 1:
                        result = _b.sent();
        ...
        this.app
            ...
            .post(function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var _a, username, password, result, e_2;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        _a = req.body, username = _a.username, password = _a.password;
                        return [4 /*yield*/, this.usersService.registerUser(username, password)];
                    case 1:
                        result = _b.sent();
                        res.status(200).send(result);
                        return [3 /*break*/, 3];
